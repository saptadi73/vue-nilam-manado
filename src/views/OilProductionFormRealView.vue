...
<template>
  <section class="space-y-6">
    ...
    <div class="flex flex-wrap gap-2">
      <button type="button" class="btn-muted" @click="router.push('/real/produksi-minyak')">Kembali ke List Produksi Minyak</button>
    </div>
    ...
    <div v-else class="rounded-2xl border border-white/10 bg-black/20 p-4 sm:p-5">
      ...
      <div class="mt-5 flex flex-col gap-2 sm:flex-row sm:justify-end">
        <button type="button" class="btn-muted w-full sm:w-auto" @click="router.push('/real/produksi-minyak')">Batal</button>
        ...
        <button v-else type="button" class="btn-primary w-full sm:w-auto" @click="router.push(`/real/produksi-minyak/${props.id}/edit`)">
          Edit Data
        </button>
      </div>
    </div>
